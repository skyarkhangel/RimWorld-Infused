    ...
    public class ModInitComponent : MonoBehaviour
    {
        private void OnLevelWasLoaded( int level )
        {
            ...
            try
            {
                ...
                InjectVarious();
                Log.Message( "Infused: Initialized." );
            }
            catch ( Exception ex )
            {
                Log.Error( "Infused: Error Initializing. Exception:\n" + ex );
            }
        }
	    ...
	    private void InjectVarious()
	    {
		    ...
		    if ( field == null )
		    {
			    throw new Exception( "Infused: field is null" );
		    }
		    var defsByName = field.GetValue( null ) as Dictionary< string, ThingDef >;
		    if ( defsByName == null )
		    {
			    throw new Exception( "Infused: Could not access private members" );
		    }
		    try
		    {
			    foreach (
		    ...
		    {
			    throw new Exception("Infused: Met error while injecting.\n" + e);
		    }
        }
